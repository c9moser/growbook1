...
/* ./.libs/lt-growbook.c - temporary wrapper executable for .libs/growbook.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-9

   The growbook program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C;C:\\msys64\\msys64\\mingw64\\lib;C;C:\\msys64\\msys64\\mingw64\\bin;C;C:\\msys64\\msys64\\mingw64\\lib\\;";
const char * TARGET_PROGRAM_NAME = "growbook.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# growbook - temporary wrapper script for .libs/growbook.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-9\n", f);
  fputs ("#\n", f);
  fputs ("# The growbook program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"growbook.exe:growbook:$LINENO: libtool wrapper (GNU libtool) 2.4.6 De", f);
  fputs ("bian-2.4.6-9\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"growbook.exe:growbook:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"growbook.exe:growbook:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=C:/msys64/mingw64/lib:C:/msys64/mingw64/bin:C:/msys64/mingw64/lib/:$PA", f);
  fputs ("TH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
